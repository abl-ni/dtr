	...
	<li :data-notification-id="request.notifications.id">
	  <a href="javascript:;">
	    ...
	    <div class="pull-right">
	      <span class="btn btn-success btn-xs" @click="accept(request.notifications.id, $event)">Accept</span>
	      <span class="btn btn-danger btn-xs" @click="cancel(request.notifications.id, $event)">Cancel</span>
	    </div>
	  </a>
	</li>
</template>
