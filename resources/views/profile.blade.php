              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="{{ asset('vendor/dist/img/avatar5.png')}}" alt="user image">
                        <span class="username">
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="{{ asset('vendor/dist/img/avatar5.png')}}" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
